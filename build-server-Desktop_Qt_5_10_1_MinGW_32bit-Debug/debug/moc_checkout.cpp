...
QT_MOC_LITERAL(1, 9, 5), // "query"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 17) // "on_search_clicked"

    },
    "checkout\0query\0\0on_search_clicked"
};
...
static const uint qt_meta_data_checkout[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::QDateTime, QMetaType::QDateTime,    2,    2,    2,
...
void checkout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->query((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QDateTime(*)>(_a[2])),(*reinterpret_cast< QDateTime(*)>(_a[3]))); break;
        ...
        {
            typedef void (checkout::*_t)(QString , QDateTime , QDateTime );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&checkout::query)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void checkout::query(QString _t1, QDateTime _t2, QDateTime _t3)
{
